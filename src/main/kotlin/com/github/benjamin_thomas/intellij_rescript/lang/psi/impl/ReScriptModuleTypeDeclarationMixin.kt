...
abstract class ReScriptModuleTypeDeclarationMixin(node: ASTNode) : ASTWrapperPsiElement(node), PsiNameIdentifierOwner {
    ...
    override fun setName(name: String): PsiElement {
        TODO("Rename not yet implemented for ModuleTypeDeclaration")
    }
